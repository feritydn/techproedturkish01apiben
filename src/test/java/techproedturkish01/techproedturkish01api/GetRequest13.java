...
public class GetRequest13 extends TestBase{
	...
	public void get01() {
		...
		// ilk bes ismin Tiger Nixon, Garrett Winters, Ashton Cox, Cedric Kelly, Airi Satou
		// oldugunu verify ediniz.
		
		
		// 1. Yol ====> Patika tavsiye edilmez
		...
		// 2. Yol ====> dar yol cok tavsiye edilmez
